 ...
 */
@interface HMImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<HMImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<HMImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
