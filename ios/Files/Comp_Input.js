class RootView extends View {
    ...
    testAction() {
        ...
        btn1.addEventListener('tap', event => {
            input1.focused = btn1.text === 'Focus';
        ...
        actionLayout.appendChild(btn1);
        actionLayout.appendChild(btn2);
        subLayout.appendChild(input1);
        subLayout.appendChild(actionLayout);
