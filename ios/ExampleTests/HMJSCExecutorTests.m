...
@interface HMJSCExecutorTests : XCTestCase

@property (nonatomic, strong)HMJSCExecutor *executor;
@end

@implementation HMJSCExecutorTests
- (void)setUp {
    // Put setup code here. This method is called before the invocation of each test method in the class.
    self.executor = [[HMJSCExecutor alloc] init];
