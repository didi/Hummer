...
@property (nonatomic, copy) HMClosureType openCallback;
@property (nonatomic, copy) HMClosureType closeCallback;
@property (nonatomic, copy) HMClosureType errorCallback;
@property (nonatomic, copy) HMClosureType messageCallback;
...
+ (void)__onOpen:(HMClosureType)openCallback
{
    [HMWebSocket sharedInstance].openCallback = openCallback;
}

+ (void)__onClose:(HMClosureType)closeCallback
{
...
+ (void)__onMessage:(HMClosureType)messageCallback
{
