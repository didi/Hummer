...
- (void)handleResponse:(NSHTTPURLResponse *)resp
             ...
             withError:(NSError *)error
              callback:(HMClosureType)callback {
...
- (void)__setHeader:(HMBaseValue *)header {
    self.header = [header toDictionary];
}

- (NSDictionary<NSString *, id> *)__param {
    return self.param;
}

- (void)__setParam:(HMBaseValue *)param {
    self.param = [param toDictionary];
}

#pragma mark - Export Method

- (void)send:(HMClosureType)callback {
