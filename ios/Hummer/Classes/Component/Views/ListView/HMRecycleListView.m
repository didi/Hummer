...
@property (nonatomic, nullable, strong) HMBaseValue *contentViewManagedValue;
...
- (void)layoutSubviews {
    ...
    [self.contentView hm_applyLayoutPreservingOrigin:NO];
}
...
- (UICollectionViewLayoutAttributes *)preferredLayoutAttributesFittingAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes {
    ...
    CGSize jsContentViewSize = [jsContentView hm_sizeThatFits:CGSizeMake(containerSize.width, YGUndefined)];
...
@property (nonatomic, copy) HMClosureType refreshCallback;
@property (nonatomic, copy) HMClosureType loadMoreCallback;

NS_ASSUME_NONNULL_BEGIN

@property (nonatomic, nullable, strong) HMBaseValue *refreshViewManagedValue;

@property (nonatomic, nullable, strong) HMBaseValue *loadMoreViewManagedValue;
...
id (^__executeBlock)(HMClosureType, NSArray *) = ^(HMClosureType callback,
                                                          NSArray *params) {
    id result;
    if (callback) { result = callback(params); }
    return result;
};
...
- (void)__setRefreshView:(HMBaseValue *)value {
    ...
    UIView *subView = (UIView *) value.toNativeObject;
...
- (void)__setLoadMoreView:(HMBaseValue *)value {
    ...
    self.loadMoreViewManagedValue = value;
...
- (void)refresh:(NSInteger)countValue {
    self.cellCount = countValue;
    
    [self.collectionViewLayout invalidateLayout];
    [self reloadData];
}

- (void)scrollToIndex:(NSInteger)row {
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (self.cellTypeCallback) {
        ...
        NSNumber *identifierNumber = value.toNumber;
    ...
    HMBaseValue *cellJSValue = cell.contentView.subviews.lastObject.hm_value;
    ...
    if (!cellJSValue) {
        ...
        UIView *jsContentView = (UIView *) cellJSValue.toNativeObject;
        BOOL isValueKindOfView = [jsContentView isKindOfClass:[UIView class]];
        NSAssert(isValueKindOfView, @"JSValue can't be turned to view");
        
        if (isValueKindOfView) {
            if (cell.contentViewManagedValue) {
                id contentViewObject = cell.contentViewManagedValue.toNativeObject;
            ...
            cell.contentViewManagedValue = cellJSValue;
        }
    }
