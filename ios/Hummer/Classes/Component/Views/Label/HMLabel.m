...
- (void)__setRichText:(HMBaseValue *)value {
    ...
    NSArray *valueArray = value.toArray;
    NSDictionary<NSString *, id> *dictionaryValue = value.toDictionary;
    ...
    self.attributedText = [self.builder buildAttributedString:valueArray ?: dictionaryValue ? @[dictionaryValue] : @[]];
    [self hm_markDirty];
}
