...
- (NSDictionary<NSString *,HMExportProperty *> *)propertyList {
    __block NSMutableDictionary<NSString *,HMExportProperty *> *propertyList = nil;
    [self.classMethodPropertyList enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull key, HMExportBaseClass * _Nonnull obj, BOOL * _Nonnull stop) {
        if (![obj isKindOfClass:HMExportProperty.class]) {
            return;
        }
        if (!propertyList) {
            propertyList = NSMutableDictionary.dictionary;
        }
        propertyList[key] = (HMExportProperty *) obj;
    }];
    [self.instanceMethodPropertyList enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull key, HMExportBaseClass * _Nonnull obj, BOOL * _Nonnull stop) {
        if (![obj isKindOfClass:HMExportProperty.class]) {
            return;
        }
        if (!propertyList) {
...
- (NSDictionary<NSString *,HMExportMethod *> *)methodList {
    __block NSMutableDictionary<NSString *,HMExportMethod *> *methodList = nil;
    [self.classMethodPropertyList enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull key, HMExportBaseClass * _Nonnull obj, BOOL * _Nonnull stop) {
        if (![obj isKindOfClass:HMExportMethod.class]) {
            return;
        }
        if (!methodList) {
            methodList = NSMutableDictionary.dictionary;
        }
        methodList[key] = (HMExportMethod *) obj;
    }];
    [self.instanceMethodPropertyList enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull key, HMExportBaseClass * _Nonnull obj, BOOL * _Nonnull stop) {
        if (![obj isKindOfClass:HMExportMethod.class]) {
            return;
