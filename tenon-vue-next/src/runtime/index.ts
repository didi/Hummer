...
import { Page, ScrollPage } from './nodes/index'
...
import { initGlobalProxy } from './helper/global-proxy-helper'
...
export let container: (Page | ScrollPage | null) = null
...
export const createRootContainer = (options: PageOptions): Page | ScrollPage => {
