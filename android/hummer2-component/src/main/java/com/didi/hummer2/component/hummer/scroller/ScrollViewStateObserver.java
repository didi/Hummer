...
public class ScrollViewStateObserver {
    ...
    private int mScrollState = OnScrollStateListener.SCROLL_STATE_IDLE;
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == MSG_SCROLL) {
                ...
                if (!mIsTouched && mLastScroll == scroll) {
                    ...
                    setScrollState(OnScrollStateListener.SCROLL_STATE_SCROLL_FINISH);
                } else {
                    mLastScroll = scroll;
    ...
    public void onScrollChanged(int scroll, int oldScroll) {
        ...
        if (!mIsScrollStarted) {
            ...
            setScrollState(OnScrollStateListener.SCROLL_STATE_SCROLL_START);
        }
        if (mIsTouched) {
            setScrollState(OnScrollStateListener.SCROLL_STATE_SCROLLING);
        } else {
            setScrollState(OnScrollStateListener.SCROLL_STATE_SCROLL_TOUCH_UP);
        }
    }
