package com.didi.hummer2.component.hummer.view;
...
import com.didi.hummer2.render.component.view.HummerLayoutExtendView;
...
public class View extends HummerLayoutExtendView {
    ...
    public void appendChild(HMBase child) {
        ...
        if (child instanceof Image
                || child instanceof Scroller
                || child instanceof HorizontalScroller
