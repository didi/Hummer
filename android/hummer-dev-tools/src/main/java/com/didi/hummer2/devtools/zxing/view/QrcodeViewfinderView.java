...
package com.didi.hummer2.devtools.zxing.view;
...
import com.didi.hummer2.devtools.zxing.camera.CameraManager;
...
public final class QrcodeViewfinderView extends View {
    ...
    public QrcodeViewfinderView(Context context, AttributeSet attrs) {
        ...
        //初始化自定义属性信息
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.QrcodeViewfinderView);

        try {
            laserColor = array.getColor(R.styleable.QrcodeViewfinderView_dkLaserColor, 0x00FF00);
            cornerColor = array.getColor(R.styleable.QrcodeViewfinderView_dkCornerColor, 0x00FF00);
            frameColor = array.getColor(R.styleable.QrcodeViewfinderView_dkFrameColor, 0xFFFFFF);
            resultPointColor = array.getColor(R.styleable.QrcodeViewfinderView_dkResultPointColor, 0xC0FFFF00);
            maskColor = array.getColor(R.styleable.QrcodeViewfinderView_dkMaskColor, 0x60000000);
            resultColor = array.getColor(R.styleable.QrcodeViewfinderView_dkResultColor, 0xB0000000);
            labelTextColor = array.getColor(R.styleable.QrcodeViewfinderView_dkLabelTextColor, 0x90FFFFFF);
            labelText = array.getString(R.styleable.QrcodeViewfinderView_dkLabelText);
            labelTextSize = array.getFloat(R.styleable.QrcodeViewfinderView_dkLabelTextSize, 36f);
        } finally {
            array.recycle();
        }
