package com.didi.hummer2.core.engine.napi.jni;

import android.util.LongSparseArray;

import com.didi.hummer2.core.engine.JSContext;
import com.didi.hummer2.core.exception.ExceptionCallback;
...
public class JSException {
    ...
    public static void init() {
        ...
        init((jsContext, errMsg) -> {
            dispatchExceptionCallback(jsContext, new com.didi.hummer2.core.exception.JSException(errMsg));
        });
    }
