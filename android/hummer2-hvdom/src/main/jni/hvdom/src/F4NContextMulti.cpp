...
void F4NContextMulti::init(ConfigOptions *configOptions, ComponentFactory *componentFactory) {
...
void F4NContextMulti::setMainThreadHandler(ThreadHandler *vdomThreadHandler) {
...
JsiValue *F4NContextMulti::render(Element *rootElement) {
    return contextDelegate_->render(rootElement);
}

ConfigOptions *F4NContextMulti::getConfigOptions() {
