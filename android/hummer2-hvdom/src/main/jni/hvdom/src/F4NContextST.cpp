...
void F4NContextST::init(ConfigOptions *configOptions, ComponentFactory *componentFactory) {
...
void F4NContextST::setMainThreadHandler(ThreadHandler *threadHandler) {
...
JsiValue * F4NContextST::evaluateJavaScript(const char *script, const char *scriptId) {
