...
/**
 * 定位坐标系转换（WGS-84 -> GCJ-02）
 *
 * Created by XiaoFeng on 2021/7/15.
 */
public class LocationTransfer {
    ...
    public static Location transform(Location location) {
        ...
        double[] locPair = transform(location.getLongitude(), location.getLatitude());
        location.setLongitude(locPair[0]);
        location.setLatitude(locPair[1]);
        return location;
    }
