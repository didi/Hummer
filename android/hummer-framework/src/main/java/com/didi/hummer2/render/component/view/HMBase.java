...
import com.didi.hummer2.render.component.anim.Transition;
...
//            callback.call(node);
    ...
    public void setElementNode(Element elementNode) {
    ...
    public boolean setElementStyle(String key, Object value) {
        if (elementNode != null) {
            return elementNode.setElementStyle(key, value);
        }
        return false;
    }
...
//                    Matcher matcher = pattern.matcher((CharSequence) value);
        ...
        ObjectAnimator anim = ObjectAnimator.ofPropertyValuesHolder(animViewWrapper, propertyValuesHolderList.toArray(new PropertyValuesHolder[propertyValuesHolderList.size()]));
    ...
    public interface PositionChangedListener {
         ...
         * 子元素 position 改变时 触发
         */
        void dispatchChildPositionChanged(HMBase child, HummerLayoutExtendUtils.Position origin, HummerLayoutExtendUtils.Position replace);
    }
    ...
    public interface DisplayChangedListener {
         ...
         * 子元素 display 改变时 触发
         */
        void dispatchChildDisplayChanged(HMBase child, HummerLayoutExtendUtils.Display origin, HummerLayoutExtendUtils.Display replace);
    }
}
