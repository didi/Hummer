package com.didi.hummer2.render.style;
...
import com.didi.hummer2.render.utility.RemUtil;
...
public class HummerStyleUtils {
    ...
    private final static List<String> YOGA_STYLES = Arrays.asList(Yoga.JUSTIFY_CONTENT, Yoga.ALIGN_CONTENT, Yoga.ALIGN_ITEMS, Yoga.ALIGN_SELF, Yoga.ASPECT_RATIO, Yoga.BORDER, Yoga.BORDER_ALL, Yoga.BORDER_LEFT, Yoga.BORDER_RIGHT, Yoga.BORDER_TOP, Yoga.BORDER_BOTTOM, Yoga.BORDER_START, Yoga.BORDER_END, Yoga.BORDER_HORIZONTAL, Yoga.BORDER_VERTICAL, Yoga.DIRECTION, Yoga.DISPLAY, Yoga.FLEX, Yoga.FLEX_BASIS, Yoga.FLEX_DIRECTION, Yoga.FLEX_GROW, Yoga.FLEX_SHRINK, Yoga.FLEX_WRAP, Yoga.WIDTH, Yoga.HEIGHT, Yoga.MAX_WIDTH, Yoga.MAX_HEIGHT, Yoga.MIN_WIDTH, Yoga.MIN_HEIGHT, Yoga.MARGIN, Yoga.MARGIN_ALL, Yoga.MARGIN_LEFT, Yoga.MARGIN_RIGHT, Yoga.MARGIN_TOP, Yoga.MARGIN_BOTTOM, Yoga.MARGIN_START, Yoga.MARGIN_END, Yoga.MARGIN_HORIZONTAL, Yoga.MARGIN_VERTICAL, Yoga.PADDING, Yoga.PADDING_ALL, Yoga.PADDING_LEFT, Yoga.PADDING_RIGHT, Yoga.PADDING_TOP, Yoga.PADDING_BOTTOM, Yoga.PADDING_START, Yoga.PADDING_END, Yoga.PADDING_HORIZONTAL, Yoga.PADDING_VERTICAL, Yoga.POSITION, Yoga.POSITION_TYPE, Yoga.POSITION_ALL, Yoga.POSITION_LEFT, Yoga.POSITION_RIGHT, Yoga.POSITION_TOP, Yoga.POSITION_BOTTOM, Yoga.POSITION_START, Yoga.POSITION_END, Yoga.POSITION_HORIZONTAL, Yoga.POSITION_VERTICAL, Yoga.LEFT, Yoga.RIGHT, Yoga.TOP, Yoga.BOTTOM, Yoga.START, Yoga.END);

    /**
     * 数值类型的属性白名单（不需要dp转换）
     */
    private final static List<String> NON_DP_STYLES = new LinkedList<>(Arrays.asList(Yoga.ASPECT_RATIO, Yoga.FLEX, Yoga.FLEX_GROW, Yoga.FLEX_SHRINK, Hummer.OPACITY, Hummer.TEXT_LINE_CLAMP, Hummer.LETTER_SPACING, Hummer.LINE_SPACING_MULTI, Hummer.MAX_LENGTH, Hummer.COLUMN));

    /**
     * 数值类型的属性白名单（不需要dp转换）
     */
    private final static List<String> TRANSITION_STYLES = new LinkedList<>(Arrays.asList(Yoga.WIDTH, Yoga.HEIGHT, Hummer.BACKGROUND_COLOR, Hummer.OPACITY, Hummer.TRANSFORM));
