...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  ...
  request() {
    ...
    const requestMy = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    requestMy.url = url;
    requestMy.method = "GET";
    requestMy.send(response => {
      console.log("response data: " + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(response.data));
  ...
  updateTestView(data) {
    data.forEach(name => {
      ...
      button.addEventListener("tap", event => {
        ...
        Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).openPage(pageInfo, data => {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/UnitTestList.js.map