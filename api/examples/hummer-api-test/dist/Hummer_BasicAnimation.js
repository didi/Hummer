...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    let anim = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('position');
    anim.value = {
      x: 120,
      y: -70
    };
    ...
    // scale/scaleX/scaleY
    let anim2 = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('scale');
    anim2.value = 1.8;
    anim2.duration = 3;
    anim2.delay = 1;
    anim2.repeatCount = 1;
    anim2.easing = 'linear';
    let anim3 = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('rotationX');
    anim3.value = 180;
    anim3.duration = 3;
    anim3.delay = 1;
    anim3.repeatCount = 1;
    anim3.easing = 'linear';
    var animView2 = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    animView2.style = {
      width: 120,
      height: 120,
      backgroundColor: "#FF000080"
    };
    let keyframeAnim = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('position');
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Hummer_BasicAnimation.js.map