...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    var request = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    request.url = "http://xxx.xxx.xxx.xxx:8000/test";
    request.method = "GET";
    request.send(response => {
      console.log("----请求结果", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(response));
    });
  }
}
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Hummer_Request.js.map