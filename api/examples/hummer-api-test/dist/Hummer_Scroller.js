...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    this.scroll = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    this.scroll.style = {
      width: '100%',
      height: '100%'
      //            showScrollBar: true,
    ...
    for (let i = 0; i < 10; i++) {
      let item = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
      item.text = "文本：" + i;
      item.style = {
        height: 120,
        margin: 15,
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Hummer_Scroller.js.map