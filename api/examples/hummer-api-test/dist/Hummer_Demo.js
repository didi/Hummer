...
var _require = __webpack_require__(/*! @hummer/hummer-front */ "@hummer/hummer-front"),
  Button = _require.Button;
var _require2 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@didi/hummerx-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
  HMXDeviceInfo = _require2.HMXDeviceInfo;
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    _this.index = 1;
    _this.callbacks = [];
    _this.createButton("isSimReady", function () {
      var data = HMXDeviceInfo.isSimReady();
      _this.showLog("HMXDeviceInfo.isSimReady() = " + data);
    });
    _this.createButton("isDataOn", function () {
      var ok = HMXDeviceInfo.isDataOn();
      _this.showLog("HMXDeviceInfo.isDataOn() = " + ok);
    });
    _this.createButton("isAirplaneModeOn", function () {
      var ok = HMXDeviceInfo.isAirplaneModeOn();
      _this.showLog("HMXDeviceInfo.isAirplaneModeOn() = " + ok);
    });
    _this.createButton("isNetworkAvailable", function () {
      var ok = HMXDeviceInfo.isNetworkAvailable();
      _this.showLog("HMXDeviceInfo.isNetworkAvailable" + "() = " + ok);
    });
    _this.createButton("isScreenLocked", function () {
      var ok = HMXDeviceInfo.isScreenLocked();
      _this.showLog("HMXDeviceInfo.isScreenLocked() = " + ok);
    });
    _this.createButton("getDiskFreeSpace", function () {
      var ok = HMXDeviceInfo.getDiskFreeSpace();
      _this.showLog("HMXDeviceInfo.getDiskFreeSpace() = " + ok);
    });
    _this.createButton("checkAccelerometer", function () {
      var ok = HMXDeviceInfo.checkAccelerometer();
      _this.showLog("HMXDeviceInfo.checkAccelerometer() = " + ok);
    });
    _this.createButton("checkGyroscope", function () {
      var ok = HMXDeviceInfo.checkGyroscope();
      _this.showLog("HMXDeviceInfo.checkGyroscope() = " + ok);
    });
    _this.createButton("checkMagneticField", function () {
      var ok = HMXDeviceInfo.checkMagneticField();
      _this.showLog("HMXDeviceInfo.checkMagneticField() = " + ok);
    });
    _this.appendChild(scrollView);
    _this.callAll();
    return _this;
  }
  (0,_Users_didi_nvm_versions_node_v20_9_0_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    key: "createButton",
    value: function createButton(text, callback) {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.165.91:8000/Hummer_Demo.js.map
}
