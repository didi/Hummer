...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  ...
  operator() {
    ...
    // 元素id
    idText = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    idText.text = "元素id";
    idText.style = {
      display: "block",
      width: 100
    ...
    // 操作列表
    let operation = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    operation.style = {
      display: "block",
      width: 200
    };
    ...
    // 添加节点
    btnAdd = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    btnAdd.text = "添加节点";
    btnAdd.style = btnCss;
    ...
    // 删除节点
    btnDelete = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    btnDelete.text = "删除节点";
    ...
    // 更新position
    btnPosition = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    ...
    // 更新display
    btnDisplay = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
  ...
  playground() {
    let id = count;
    count++;
    playground = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("".concat(id));
    playground.style = {
      display: "block",
      position: "relative",
      padding: 10,
  ...
  genView() {
    let id = count;
    count++;
    let v = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("".concat(id));
    v.text = "".concat(id);
    v.style = {
      display: "block",
      position: "relative",
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Comp_Layout.js.map