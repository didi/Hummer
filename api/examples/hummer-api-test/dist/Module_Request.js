...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  ...
  testRequest() {
    ...
    btn1.addEventListener('tap', e => {
      let request = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
      request.url = 'http://172.23.161.161:8000/fileList';
      request.method = 'GET';
      request.send(response => {
        console.log('method: ' + request.method);
        console.log('response type is ' + typeof response);
        console.log('response: ' + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(response));
        let ret = 'method: ' + request.method + '\n' + 'response type is ' + typeof response + '\n' + 'response: ' + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(response) + '\n';
        infoText.text = ret;
      });
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Module_Request.js.map