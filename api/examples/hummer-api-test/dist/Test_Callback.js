...
class RootView extends View {
  constructor() {
    super();
    console.log("nativeData: " + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_1___default()(Hummer.nativeData));
    this.style = {
  ...
  testJsCallNative() {
    ...
    // JS -> Native
    let ret = Test.nativeFunc(111, 222.22, {
      aa: 11,
      bb: true
    }, [55.55, false], (aa, bb) => {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Test_Callback.js.map