  ...
  constructor() {
    ...
    btn1.addEventListener('tap', event => {
      ...
      Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).openPage(pageInfo, result => {
        console.log('Page result: ' + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(result));
      });
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Comp_Navigator_Page1.js.map