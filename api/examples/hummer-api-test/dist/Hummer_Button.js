...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    let storage = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();

    // storage.exist('daijiaStorage', (res) => {
    //     console.log("----storage查询成功", JSON.stringify(res))
    // })

    let isSet = storage.set('daijiaStorage1', _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()({
      name: 'hummer1',
      other: 'hummer_api1'
    }));
    console.log("----isSet1storage是否设置成功", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(isSet));
    let isSet2 = storage.set('daijiaStorage2', _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()({
      name: 'hummer2',
      other: 'hummer_api2'
    }));
    console.log("----isSet2storage是否设置成功", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(isSet2));
    button.addEventListener('tap', event => {
      console.log('my button clicked');
      button.text = button.text + "1";
      let res1 = storage.exist('daijiaStorage1');
      console.log("----获取到的数据1", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(res1));
      let res2 = storage.get('daijiaStorage2');
      console.log("----获取到的数据2", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(res2));
    });
    let button2 = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    button.text = '按钮文案2';
    // button.disabled = true
    ...
    button2.addEventListener('tap', event => {
      ...
      console.log("删除后获取----获取到的数据1", _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(res1));
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Hummer_Button.js.map