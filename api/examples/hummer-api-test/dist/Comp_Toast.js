...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    btn1.addEventListener('tap', event => {
      // Toast.show("test");
      Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).show("test", 3000);
    });
    ...
    btn2.addEventListener('tap', event => {
      ...
      Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).custom(layout);
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Comp_Toast.js.map