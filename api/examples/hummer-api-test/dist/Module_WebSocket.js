...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  ...
  testRequest() {
    ...
    btn1.addEventListener('tap', e => {
      this.ws = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('ws://x.x.x.x:8000/proxy/native');
      this.ws.onopen = () => {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Module_WebSocket.js.map