...
class RootView extends Object(function webpackMissingModule() { var e = new Error("Cannot find module './../../../packages/hummer-api/dist/hummer-api.es'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
  constructor() {
    ...
    let a = input.style;
    console.log("------3-3-3-3-3", a, _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(a));
    input.addEventListener('input', event => {
      console.log("-----------input默认值是：", input.text);
      console.log("事件1:" + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(event));
    });
    input.addEventListener('input', event => {
      console.log("事件2:" + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(event));
    });
    ...
    textArea.addEventListener('input', event => {
      ...
      console.log("hummer textArea state11111:" + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(event));
    });
    textArea.addEventListener('input', event => {
      console.log("hummer textArea state222222:" + _Users_didi_nvm_versions_node_v16_20_0_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_2___default()(event));
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.145.60:8000/Hummer_Input.js.map