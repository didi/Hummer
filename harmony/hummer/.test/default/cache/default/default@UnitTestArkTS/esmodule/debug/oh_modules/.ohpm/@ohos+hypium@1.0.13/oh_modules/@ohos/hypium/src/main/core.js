...
import {SuiteService, SpecService, ExpectService, ReportService} from '@package:pkg_modules/.ohpm/@ohos+hypium@1.0.13/pkg_modules/@ohos/hypium/src/main/service';
import {ConfigService} from '@package:pkg_modules/.ohpm/@ohos+hypium@1.0.13/pkg_modules/@ohos/hypium/src/main/module/config/configService';
import {SpecEvent, TaskEvent, SuiteEvent} from '@package:pkg_modules/.ohpm/@ohos+hypium@1.0.13/pkg_modules/@ohos/hypium/src/main/event';
