...
export function unrecognizedMethod(name:string) : string{
  return HUMMER_CALL_NATIVE_ERROR + name;
}


export function componentNotFind(name:string) : string{
  return HUMMER_CALL_CREATE_ERROR + name;
}


export function dataNotFind(name:string) : string{
  return HUMMER_CALL_DATA_ERROR + name;
}

export function invalidArg(name:string) : string{
  return HUMMER_INVALID_ARG_ERROR + name;
}

export function domOperationError(name:string) : string{
