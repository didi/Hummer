...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    console.log("nativeData: " + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_5___default()(Hummer.nativeData));
    _this.style = {
    ...
    _this.testNativeCallJs();
    _this.testJsCallNative();
    return _this;
  }
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    key: "testNativeCallJs",
    value: function testNativeCallJs() {
    ...
    key: "testJsCallNative",
    value: function testJsCallNative() {
      var titleView = new Text();
      ...
      // JS -> Native
      var ret = Test.nativeFunc(111, 222.22, {
        aa: 11,
        bb: true
      }, [55.55, false], function (aa, bb) {
        console.log('-- callback aa: ' + aa + ", bb: " + bb);
      });
      var info = "Test.nativeFunc: " + ret + "\n";
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Test_Callback.js.map
}
