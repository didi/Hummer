...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var isSet = storage.set('daijiaStorage1', _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()({
      name: 'hummer1',
      other: 'hummer_api1'
    }));
    console.log("----isSet1storage是否设置成功", _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(isSet));
    var isSet2 = storage.set('daijiaStorage2', _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()({
      name: 'hummer2',
      other: 'hummer_api2'
    }));
    console.log("----isSet2storage是否设置成功", _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(isSet2));
    button.addEventListener('tap', function (event) {
      console.log('my button clicked');
      button.text = button.text + "1";
      var res1 = storage.exist('daijiaStorage1');
      console.log("----获取到的数据1", _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(res1));
      var res2 = storage.get('daijiaStorage2');
      console.log("----获取到的数据2", _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(res2));
    });
    ...
    button2.addEventListener('tap', function (event) {
      ...
      var res1 = storage.get('daijiaStorage1');
      console.log("删除后获取----获取到的数据1", _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(res1));
    });
    _this.appendChild(button);
    _this.appendChild(button2);
    return _this;
  }
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Button.js.map
}
