...
var data = ['https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3207781657,3460758070&fm=27&gp=0.jpg', 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2735633715,2749454924&fm=27&gp=0.jpg', 'https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3464499095,1074840881&fm=27&gp=0.jpg'];
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    _this.pager = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.ViewPager("pager");
    _this.pager.style = {
      width: '100%',
      height: 170,
      itemSpacing: 20,
    ...
    _this.pager.onPageChange(function (current, total) {
      console.log("ViewPager onPageChange, index: " + (current + 1) + "/" + total);
    });
    _this.pager.onItemClick(function (position) {
      console.log("ViewPager onItemClick, position: " + position);
    });
    _this.pager.onItemView(function (position, view) {
      var image = view;
      if (!image) {
        image = new Image();
        image.style = {
      ...
      image.src = _this.data[position];
      return image;
    });
    _this.updateData(data);
    _this.pager.setCurrentItem(1);
    layout.appendChild(_this.pager);
    _this.appendChild(titleView);
    _this.appendChild(layout);

    // 底部tap切换按钮
    var tabLayout = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
    tabLayout.style = {
      flexDirection: 'row',
      alignSelf: 'center',
      width: 200
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Comp_ViewPager.js.map
}
