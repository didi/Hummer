...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var a = input.style;
    console.log("------3-3-3-3-3", a, _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(a));
    input.addEventListener('input', function (event) {
      console.log("-----------input默认值是：", input.text);
      console.log("事件1:" + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(event));
    });
    input.addEventListener('input', function (event) {
      console.log("事件2:" + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(event));
    });
    ...
    textArea.addEventListener('input', function (event) {
      ...
      console.log("hummer textArea state11111:" + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(event));
    });
    textArea.addEventListener('input', function (event) {
      console.log("hummer textArea state222222:" + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(event));
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Input.js.map
}
