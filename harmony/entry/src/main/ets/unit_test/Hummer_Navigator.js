  ...
  function RootView() {
    ...
    button.addEventListener('tap', function (event) {
      ...
      _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Navigator.openPage(pageInfo, function (result) {
        console.log('下一个页面的返回值Page result: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(result));
      });
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Navigator.js.map
}
