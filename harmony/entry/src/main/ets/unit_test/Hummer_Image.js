...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var imageView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
    imageView.style = {
      width: 80,
      height: 80,
      resize: 'cover'
    ...
    var imageView1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
    imageView1.style = {
      width: 80,
      height: 80,
      resize: 'cover'
    ...
    var imageView2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
    imageView2.style = {
      width: 80,
      height: 80,
      resize: 'stretch'
    };
    imageView2.load('http://xxx/test.jpg', function (srcType, isSuccess) {});
    imageView2.load({
      src: 'http://xxx/test.jpg',
      placeholder: 'http://xxx/holder.jpg',
      failedImage: 'http://xxx/failed.jpg'
    }, function (srcType, isSuccess) {});
    _this.appendChild(imageView);
    _this.appendChild(imageView1);
    _this.appendChild(imageView2);
    return _this;
  }
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Image.js.map
}
