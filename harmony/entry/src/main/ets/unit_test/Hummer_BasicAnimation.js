...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation('position');
    anim.value = {
      x: 120,
      y: -70
    };
    ...
    // scale/scaleX/scaleY
    var anim2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation('scale');
    anim2.value = 1.8;
    anim2.duration = 3;
    anim2.delay = 1;
    anim2.repeatCount = 1;
    anim2.easing = 'linear';
    var anim3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation('rotationX');
    anim3.value = 180;
    anim3.duration = 3;
    anim3.delay = 1;
    anim3.repeatCount = 1;
    anim3.easing = 'linear';
    var animView2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
    animView2.style = {
      width: 120,
      height: 120,
      backgroundColor: "#FF000080"
    };
    var keyframeAnim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation('position');
    ...
    keyframeAnim.on("start", function () {
      console.log("------动画开始");
    });
    keyframeAnim.on("end", function () {
      console.log("------动画结束");
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_BasicAnimation.js.map
}
