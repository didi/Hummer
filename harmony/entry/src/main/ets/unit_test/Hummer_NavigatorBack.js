...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var pageInfo = _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Hummer.pageInfo;
    console.log('后一个页面接收到的pageInfo: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(pageInfo));
    var result = {
      key1: 111,
      key2: 222
    };
    _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Hummer.pageResult = result;
    var memory = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Memory();
    var isExit = memory.exist('daijia');
    console.log("memory是否存在", isExit);
    var val = memory.get('daijia');
    ...
    var event1 = function event1(e) {
      console.log("接受前一个页面触发myHummer事件", e);
    };
    var event2 = function event2(e) {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_NavigatorBack.js.map
}
