...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    // 显示提示对话框
    dialog.alert("test");
    dialog.alert("test", "OK", function () {
      Toast.show('ok click');
    });

    // 显示确认对话框
    dialog.confirm("title", "test");
    dialog.confirm("title", "test", "OK", "Cancel", function () {
      Toast.show('ok click');
    }, function () {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Dialog.js.map
}
