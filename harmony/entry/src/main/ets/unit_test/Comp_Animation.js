...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var isKeyFrame = true;
    var layout0 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
    layout0.style = {
      flexDirection: 'row'
    };
    ...
    var button1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button1.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    var button2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button2.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    var button3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button3.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    var button4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button4.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button4.addEventListener("tap", function (event) {
      animScale("scaleY");
    });
    var button5 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button5.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button5.addEventListener("tap", function (event) {
      animRotation("rotationX");
    });
    var button6 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button6.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button6.addEventListener("tap", function (event) {
      animRotation("rotationY");
    });
    var button7 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button7.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button7.addEventListener("tap", function (event) {
      animRotation("rotationZ");
    });
    var button8 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button("button8");
    button8.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button8.addEventListener("tap", function (event) {
      animAlpha();
    });
    var button9 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button9.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button9.text = "背景颜色渐变";
    button9.addEventListener("tap", function (event) {
      animBackgroundColor();
    });
    var button10 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button10.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button10.text = "宽度和高度";
    button10.addEventListener("tap", function (event) {
      animWidthHeight();
    });
    var button11 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button11.style = {
      width: 150,
      height: 40,
      fontSize: 16
    ...
    button11.text = "Skew";
    button11.addEventListener("tap", function (event) {
      animSkew();
    });
    var button31 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button31.style = {
      width: 120,
      height: 40,
      fontSize: 16
    ...
    button31.addEventListener("tap", function (event) {
      animView.removeAnimationForKey("xx");
    });
    var button32 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
    button32.style = {
      width: 120,
      height: 40,
      fontSize: 16
    ...
    button32.addEventListener("tap", function (event) {
      animView.removeAllAnimation();
    });
    var animView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
    animView.style = {
      top: 60,
      left: 10,
      width: 120,
    ...
    _this.appendChild(layout0);
    _this.appendChild(animView);

    // 平移动画
    function animTranslation() {
      var anim;
      if (!isKeyFrame) {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("position");
        anim.value = {
          x: 120,
          y: -70
        };
        ...
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("position");
        anim.keyframes = [{
          percent: 0,
          value: {
            x: 0,
    ...
    function animScale(type) {
      var anim;
      if (!isKeyFrame) {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation(type);
        anim.value = "1.8";
        anim.easing = "linear";
      } else {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation(type);
        anim.keyframes = [{
          percent: 0.2,
          value: "0.5",
          easing: "linear"
    ...
    function animAlpha() {
      var anim;
      if (!isKeyFrame) {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("opacity");
        anim.value = "0.5";
        anim.easing = "linear";
      } else {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("opacity");
        anim.keyframes = [{
          percent: 0.2,
          value: "0.5",
          easing: "linear"
    ...
    function animBackgroundColor() {
      var anim;
      if (!isKeyFrame) {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("backgroundColor");
        anim.value = "#0000ff80";
        anim.easing = "linear";
      } else {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("backgroundColor");
        anim.keyframes = [{
          percent: 0.2,
          value: "#ff000080",
          easing: "linear"
    ...
    function animWidthHeight() {
      ...
      var anim2;
      if (!isKeyFrame) {
        anim1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("width");
        anim1.from = 50;
        anim1.value = 200;
        anim1.easing = "linear";
        anim2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("height");
        anim2.from = 50;
        anim2.value = 200;
        anim2.easing = "linear";
      } else {
        anim1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("width");
        anim1.keyframes = [{
          percent: 0.2,
          value: 170
        }, {
        ...
        anim2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("height");
        anim2.keyframes = [{
          percent: 0.2,
          value: 170
        }, {
    ...
    function animSkew() {
      var anim;
      if (!isKeyFrame) {
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.BasicAnimation("skew");
        anim.value = {
          x: 45,
          y: 60
        };
        ...
        anim = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.KeyframeAnimation("skew");
        anim.keyframes = [{
          percent: 0,
          value: {
            x: 0,
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Comp_Animation.js.map
}
