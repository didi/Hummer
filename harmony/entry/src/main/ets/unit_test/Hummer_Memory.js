...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var isSet = storage.set('daijiaStorage', _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()({
      name: 'hummer',
      other: 'hummer_api'
    }));
    console.log("----storage是否设置成功", isSet);
    var res = storage.get('daijiaStorage');
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.25:8000/Hummer_Memory.js.map
}
