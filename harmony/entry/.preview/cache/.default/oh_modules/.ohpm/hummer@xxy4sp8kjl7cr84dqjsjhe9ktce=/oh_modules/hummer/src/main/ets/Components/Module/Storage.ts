...
import { dataNotFind } from "@package:pkg_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/pkg_modules/hummer/src/main/ets/Utils/Error";
let kvManager: distributedKVStore.KVManager;
let kvStore: distributedKVStore.SingleKVStore | null; // 数据库实例
const BUNDLE_NAME = "com.hummer.dataManager";
export class HMStorage extends Component {
    // 命名空间
