import type { IHummerStyle, ITransform } from '../../Style/IHummerStyle';
import type { Node } from '../Node';
import { getVP, isUndefined } from "@package:pkg_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/pkg_modules/hummer/src/main/ets/Utils/Utils";
import { invalidArg } from "@package:pkg_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/pkg_modules/hummer/src/main/ets/Utils/Error";
...
//   mergeTransform(){}
// }
export function getAnimationStyle(node: Node, propertyName: string, value: any): IHummerStyle | undefined {
