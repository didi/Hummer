...
import type { IHummerSwiperStyle } from '../../Style/IHummerStyle';
import type { HMAny } from '../../Utils/Utils';
import { getVP } from "@package:pkg_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/pkg_modules/hummer/src/main/ets/AttributeModifiers/Utils";
...
export default class HMSwiper extends ViewPU {
    ...
    defaultImage(uri: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("oh_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/oh_modules/hummer/src/main/ets/Components/ets/Swiper.ets(197:5)");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("oh_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/oh_modules/hummer/src/main/ets/Components/ets/Swiper.ets(206:5)");
        ...
        }, Swiper);
        {
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("oh_modules/.ohpm/hummer@xxy4sp8kjl7cr84dqjsjhe9ktce=/oh_modules/hummer/src/main/ets/Components/ets/Swiper.ets(208:9)");
                    Column.onClick((e) => {
