...
import { FlexManager, getVP } from "@bundle:com.example.hummer/entry@hummer/ets/AttributeModifiers/Utils";
...
export default class HMScroller extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("hummer/src/main/ets/Components/ets/Scroller.ets(191:5)");
    ...
    buildColumn(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("hummer/src/main/ets/Components/ets/Scroller.ets(214:3)");
    ...
    buildRow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("hummer/src/main/ets/Components/ets/Scroller.ets(228:3)");
    ...
    buildFlex(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("hummer/src/main/ets/Components/ets/Scroller.ets(242:3)");
