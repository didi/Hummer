import { EventEmitter, EventMode } from "@bundle:com.example.hummer/entry@hummer/ets/Context/EventEmitter";
import type { CleanupCallback } from "@bundle:com.example.hummer/entry@hummer/ets/Context/EventEmitter";
