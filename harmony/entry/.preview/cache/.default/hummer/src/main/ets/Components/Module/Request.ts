...
import { getQueryString } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Url";
import { HUMMER_UN_SUPPORTED_TYPE_ERROR } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Error";
type HMResponse = {
    status: number;
    header?: object;
    error?: {
...
export class HMRequest extends HMComponent {
    private _url?: string;
