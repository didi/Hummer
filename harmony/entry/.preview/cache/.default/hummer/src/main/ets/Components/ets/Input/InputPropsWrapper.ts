...
import type { IHummerTextInputStyle, IInputAttributes } from './IProps';
import { InputEventName } from "@bundle:com.example.hummer/entry@hummer/ets/Components/ets/Input/Event";
