...
import { dispatchTapEvent, dispatchTouchEvent, dispatchChangeEvent, shouldBindEvent } from "@bundle:com.example.hummer/entry@hummer/ets/Components/ets/EventHandler";
import { TouchEventName, TapEventName, FocusEventName, BlurEventName, ChangeEventName, SubmitEventName } from "@bundle:com.example.hummer/entry@hummer/ets/Components/Event";
import type { IHummerTextInputStyle } from '../../Style/IHummerStyle';
import { getTextAlign, getMaxLength } from "@bundle:com.example.hummer/entry@hummer/ets/AttributeModifiers/Utils";
// type映射
const TYPE = {
...
export default class HMTextInput extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("hummer/src/main/ets/Components/ets/TextInput.ets(66:5)");
            TextInput.padding(0);
