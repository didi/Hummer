import { dispatchAnimationEndEvent, dispatchAnimationStartEvent, getAnimationStyle } from "@bundle:com.example.hummer/entry@hummer/ets/Components/Module/Animation";
import type { BasicAnimation, Keyframe, KeyframeAnimation } from "@bundle:com.example.hummer/entry@hummer/ets/Components/Module/Animation";
...
import { HUMMER_NO_UICONTEXT_ERROR } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Error";
