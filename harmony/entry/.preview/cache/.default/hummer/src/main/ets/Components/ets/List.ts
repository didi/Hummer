...
import { isUndefined, timestamp } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Utils";
import type { HMAny } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Utils";
import { getEdgeEffect, getListDirection, getScrollBarState, getVP } from "@bundle:com.example.hummer/entry@hummer/ets/AttributeModifiers/Utils";
...
export default class HMList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("hummer/src/main/ets/Components/ets/List.ets(323:5)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (this.isVertical()) {
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, paramsLambda, { page: "hummer/src/main/ets/Components/ets/List.ets", line: 325 }));
                            }
                            else {
                        ...
                        if (this.listMode === 'list') {
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("hummer/src/main/ets/Components/ets/List.ets(379:11)");
                                }, Text);
                                Text.pop();
                            });
                        }
    ...
    LoadMoreComponent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.loadMoreNode) {
                this.ifElseBranchUpdateFunction(0, () => {
                    componentFactoryBuilder.bind(this)(makeBuilderParameterProxy("componentFactoryBuilder", { hmContext: () => this.hmContext, tag: () => this.loadMoreNode.name, node: () => this.loadMoreNode, customComponentBuilder: () => this.builderContext.customComponentBuilder }));
                });
            }
            else {
                this.ifElseBranchUpdateFunction(1, () => {
    ...
    RefreshComponent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.refreshNode) {
                this.ifElseBranchUpdateFunction(0, () => {
                    componentFactoryBuilder.bind(this)(makeBuilderParameterProxy("componentFactoryBuilder", { hmContext: () => this.hmContext, tag: () => this.refreshNode.name, node: () => this.refreshNode, customComponentBuilder: () => this.builderContext.customComponentBuilder }));
                });
            }
            else {
                this.ifElseBranchUpdateFunction(1, () => {
    ...
    listBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("hummer/src/main/ets/Components/ets/List.ets(411:5)");
            ...
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("hummer/src/main/ets/Components/ets/List.ets(417:9)");
                    };
    ...
    gridBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Grid.debugLine("hummer/src/main/ets/Components/ets/List.ets(443:5)");
            ...
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("hummer/src/main/ets/Components/ets/List.ets(447:9)");
                    };
                    const observedDeepRender = () => {
    ...
    waterFallBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            WaterFlow.debugLine("hummer/src/main/ets/Components/ets/List.ets(472:5)");
        ...
        }, WaterFlow);
        {
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    FlowItem.create();
                    FlowItem.debugLine("hummer/src/main/ets/Components/ets/List.ets(476:9)");
                    FlowItem.onAppear(() => {
                        // 节点渲染时 触发onUpdate回调
                        this.attributes?.onUpdate(index, this.listItemNodeList[index]);
                    });
