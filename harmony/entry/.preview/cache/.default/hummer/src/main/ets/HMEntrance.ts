...
import { getETSBuiltinComponentRegistry } from "@bundle:com.example.hummer/entry@hummer/ets/BuiltinComponentRegistry";
...
import { EngineType, HMContext, HMContextEventType, setBuiltinComponentRegistryProvider } from "@bundle:com.example.hummer/entry@hummer/ets/Context/HMContext";
import type common from "@ohos:app.ability.common";
import type { HMContextConfig } from './Context/Config/Config';
import { isEqualArray } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Utils";
...
import type { HMNode } from "@bundle:com.example.hummer/entry@hummer/ets/Components/Node";
import type { CleanupCallback } from './Context/EventEmitter';
import { RootNode } from "@bundle:com.example.hummer/entry@hummer/ets/Components/RootNode";
import { PageOnAppear, PageOnBack, PageOnCreate, PageOnDestroy, PageOnDisappear } from "@bundle:com.example.hummer/entry@hummer/ets/Components/RootNode";
import { bindTs2EtsFunc } from "@bundle:com.example.hummer/entry@hummer/ets/Utils/Binder";
...
export class HMEntrance extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("hummer/src/main/ets/HMEntrance.ets(208:5)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
