interface PullToRefresh_Params {
    ...
    refreshStateChange?: ((state: number) => void) | null;
    loadMoreStateChange?: ((state: number) => void) | null;
...
import { PullToRefreshConfigurator } from "@bundle:com.example.hummer/entry@hummer/ets/Components/ets/PullToRefreshConfigurator";
const IS_FREE = 0;
...
const state2HummerState = (state: number, lastState: number): HummerState => {
    let hummerState = 0;
    let action = 'refresh';
    switch (state) {
        case IS_PULL_DOWN_1:
        ...
        case IS_FREE:
            hummerState = 0;
            if ([IS_PULL_UP_1, IS_PULL_UP_2, IS_LOADING].includes(lastState)) {
                action = 'loadMore';
            }
            break;
        default:
...
export class PullToRefresh extends ViewPU {
    ...
    private refreshStateChange?: ((state: number) => void) | null;
    private loadMoreStateChange?: ((state: number) => void) | null;
    //-----------------------------以下为组件内自用属性-----------------------------//
    ...
    onStateChange() {
        ...
        if (![IS_PULL_UP_1, IS_PULL_UP_2].includes(this.state as number)) {
            const hummerState = state2HummerState(this.state as number, this.lastState);
            // 触发通知
            if (hummerState.action === 'loadMore') {
                this.loadMoreStateChange && this.loadMoreStateChange(hummerState.state as number);
            }
            else {
                this.refreshStateChange && this.refreshStateChange(hummerState.state as number);
            }
        }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(168:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 下拉刷新动画部分
            Stack.create();
            Stack.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(170:7)");
            // 下拉刷新动画部分
            Stack.width('100%');
            // 下拉刷新动画部分
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 主体列表部分
            Column.create();
            Column.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(178:7)");
            // 主体列表部分
            Column.width('100%');
            // 主体列表部分
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 上拉加载动画部分
            Stack.create();
            Stack.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(187:7)");
            // 上拉加载动画部分
            Stack.width('100%');
            // 上拉加载动画部分
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.customRefresh !== undefined && this.customRefresh !== null) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(221:7)");
                        Column.width('100%');
                        Column.height('100%');
                    }, Column);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(227:7)");
                        Stack.width('100%');
                        Stack.height('100%');
                    }, Stack);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.refreshText);
                        Text.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(228:9)");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(232:9)");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Canvas.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(233:11)");
                        Canvas.width('100%');
                        Canvas.height('100%');
                        Canvas.onReady(() => {
                            this.initCanvas();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(240:11)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.customLoad !== undefined && this.customLoad !== null) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(257:7)");
                        Column.width('100%');
                        Column.height('100%');
                    }, Column);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(263:7)");
                        Row.height('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(264:9)");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(265:11)");
                        Image.width('100%');
                        Image.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(274:11)");
                        Image.width('100%');
                        Image.height('100%');
                        Image.objectFit(ImageFit.Contain);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("hummer/src/main/ets/Components/ets/PullToRefresh.ets(287:9)");
                        Text.height('100%');
                        Text.textAlign(TextAlign.Center);
                        Text.margin({ left: 8 });
