...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    btn1.addEventListener('tap', function (event) {
      _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Navigator.openPage({
        id: "333",
        url: "./Comp_Navigator_Page3.js"
      }, function (result) {
        console.log('Page result: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(result));
      });
    });
    ...
    btn2.addEventListener('tap', function (event) {
      _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Navigator.popPage();
    });
    _this.appendChild(text);
    _this.appendChild(btn1);
    _this.appendChild(btn2);
    console.log('Page info: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(_packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Hummer.pageInfo));
    _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Hummer.pageResult = {
      key1: 111.1,
      key2: "222"
    };
    return _this;
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Navigator_Page2.js.map
}
