...
import { MethodType } from "@bundle:com.example.hummer/entry/src/main/Hummer/Instruction/IPlatformInst";
import type { External, InvokeType, IPlatformInst, IPlatformRenderInst } from "@bundle:com.example.hummer/entry/src/main/Hummer/Instruction/IPlatformInst";
...
import { componentNotFind, unrecognizedMethod } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/Error";
import type Base from '../Components/Base';
import { isArray, isObject } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/is";
class GlobalObject {
