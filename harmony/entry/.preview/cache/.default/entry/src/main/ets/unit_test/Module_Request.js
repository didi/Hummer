  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testRequest() {
      ...
      btn1.addEventListener('tap', function (e) {
        var request = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Request();
        request.url = 'http://172.23.161.161:8000/fileList';
        request.method = 'GET';
        request.send(function (response) {
          console.log('method: ' + request.method);
          console.log('response type is ' + typeof response);
          console.log('response: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(response));
          var ret = 'method: ' + request.method + '\n' + 'response type is ' + typeof response + '\n' + 'response: ' + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(response) + '\n';
          infoText.text = ret;
        });
      });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Module_Request.js.map
}
