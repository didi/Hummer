...
var RootView = /*#__PURE__*/function (_View) {
  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function showAlertDialog() {
      var dialog = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Dialog();
      dialog.cancelable = false;
      // dialog.alert("test");
      dialog.alert("test", "xxx", function () {
        Toast.show('ok click');
      });
    }
  }, {
    ...
    value: function showConfirmDialog() {
      ...
      dialog.cancelable = false;
      // dialog.confirm("test");
      dialog.confirm("test title", "test msg", "xxx", "yyy", function () {
        Toast.show('ok click');
      }, function () {
    ...
    key: "showCustomDialog",
    value: function showCustomDialog() {
      ...
      var textView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      ...
      var lineView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      lineView.style = {
        width: '100%',
        height: 0.5,
      ...
      var btn1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      btn1.text = "取消";
      btn1.style = {
        flexGrow: 1,
        textAlign: "center"
      };
      var lineView2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      lineView2.style = {
        width: 0.5,
        height: '100%',
        backgroundColor: '#CCCCCC'
      };
      var btn2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      btn2.text = "确定";
      btn2.style = {
        flexGrow: 1,
        textAlign: "center"
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Dialog.js.map
}
