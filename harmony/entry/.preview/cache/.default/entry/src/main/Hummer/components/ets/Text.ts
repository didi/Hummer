...
import { getCopyOptions, getFontStyle, getFontWeight, getImageSpanAlignment, getTextAlign, getTextDecoration, getTextOverflow, getVP } from "@bundle:com.example.hummer/entry/src/main/Hummer/AttributeModifiers/Utils";
            ...
            if (this.richText) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/Hummer/Components/ets/Text.ets(82:7)");
                    }, Text);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ForEach.create();
                                ...
                                if (richTextNode.image) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            ImageSpan.debugLine("entry/src/main/Hummer/Components/ets/Text.ets(85:13)");
                                    ...
                                    this.ifElseBranchUpdateFunction(1, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            Span.debugLine("entry/src/main/Hummer/Components/ets/Text.ets(90:13)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/Hummer/Components/ets/Text.ets(106:7)");
