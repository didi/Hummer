...
import { renderFunc } from "@bundle:com.example.hummer/entry/ets/pages/Tenon";
export class Template extends ViewPU {
    ...
    setInitiallyProvidedValue(params: Template_Params) {
    ...
    updateStateVars(params: Template_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            ViewPU.create(new HMEntrance(this, { controller: this.entranceController, pageData: this.pageData, contentProvider: new HarmonyRuntimeContentProvider(renderFunc) }, undefined, elmtId, paramsLambda, { page: "entry/src/main/ets/pages/Template.ets", line: 29 }));
                        }
                        else {
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/Template.ets(28:5)");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
