interface Template_HelloWorld_Params {
    pageData?: IPageData;
...
import { renderFunc } from "@bundle:com.example.hummer/entry/ets/unit_test/HelloWorld";
export class Template_HelloWorld extends ViewPU {
    ...
    setInitiallyProvidedValue(params: Template_HelloWorld_Params) {
    ...
    updateStateVars(params: Template_HelloWorld_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            ViewPU.create(new HMEntrance(this, { controller: this.entranceController, pageData: this.pageData, contentProvider: new HarmonyRuntimeContentProvider(renderFunc) }, undefined, elmtId, paramsLambda, { page: "entry/src/main/ets/template/Template_HelloWorld.ets", line: 29 }));
                        }
                        else {
            ...
            NavDestination.debugLine("entry/src/main/ets/template/Template_HelloWorld.ets(28:5)");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
registerNamedRoute(() => new Template_HelloWorld(undefined, {}), "", { bundleName: "com.example.hummer", moduleName: "entry", pagePath: "template/Template_HelloWorld" });
