  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testAction() {
      ...
      input.addEventListener('input', function (event) {
        infoText.text = _this2.formatEvent(event);
      });
      var btn1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      btn1.text = 'Focus';
      btn1.style = {
        position: 'absolute',
        width: 70,
      ...
      var btn2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      btn2.text = 'Focus';
      btn2.style = {
        position: 'absolute',
        width: 70,
      ...
      var infoText = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
    ...
    value: function testBackground() {
      ...
      var input1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var input3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var textArea1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.TextArea();
      ...
      var textArea2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.TextArea();
      ...
      var textArea3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.TextArea();
    ...
    value: function testTextStyle() {
      ...
      var input4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var input5 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var input6 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var input7 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var input8 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      input8.text = '字体';
      input8.style = {
        width: 80,
        height: 40,
    ...
    value: function formatEvent(event) {
      ...
      var state = 'state: ' + event.state + ' - ' + this.formatEventState(event.state) + '\n';
      var position = event.position ? 'position: (' + event.position.x + ', ' + event.position.y + ')\n' : '';
      var direction = event.direction ? 'direction: ' + event.direction + '\n' : '';
      var scale = event.scale ? 'scale: ' + event.scale + '\n' : '';
      var text = event.text ? 'text: ' + event.text + '\n' : '';
      var timestamp = 'timestamp: ' + event.timestamp;
      return type + state + position + direction + scale + text + timestamp;
    }
  }, {
    key: "formatEventState",
    value: function formatEventState(state) {
      var strState = '';
      switch (state) {
        case 0:
          strState = 'Normal';
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Input.js.map
}
