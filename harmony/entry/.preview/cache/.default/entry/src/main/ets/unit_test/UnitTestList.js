...
var baseUrl = "http://172.23.161.25:8000/";
var url = baseUrl + 'fileList';
var RootView = /*#__PURE__*/function (_Scroller) {
  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function request() {
      ...
      var requestMy = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Request();
      requestMy.url = url;
      requestMy.method = "GET";
      requestMy.send(function (response) {
        console.log("response data: " + _usr_local_lib_node_modules_hummer_cli_node_modules_core_js_pure_stable_json_stringify_js__WEBPACK_IMPORTED_MODULE_6___default()(response.data));
        _this2.updateTestView(response.data.data);
      });
    }
  }, {
    key: "updateTestView",
    value: function updateTestView(data) {
      var _this3 = this;
      data.forEach(function (name) {
        ...
        button.addEventListener("tap", function (event) {
          ...
          _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Navigator.openPage(pageInfo, function (data) {
            console.log("Navigator.openPage() callback data = " + data);
          });
        });
        _this3.appendChild(button);
      });
    }
  }]);
  return RootView;
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/UnitTestList.js.map
}
