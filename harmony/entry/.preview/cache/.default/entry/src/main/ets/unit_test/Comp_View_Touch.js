...
var RootView = /*#__PURE__*/function (_View) {
  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testAllTouch() {
      ...
      var touchListener = function touchListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      var tapListener = function tapListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      var longPressListener = function longPressListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      var panListener = function panListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      var swipeListener = function swipeListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      var pinchListener = function pinchListener(event) {
        infoText.text = _this2.formatEvent(event);
      };
      ...
      var btnRemoveAllEvent = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      ...
      btnRemoveAllEvent.addEventListener('tap', function (event) {
    ...
    value: function testChildTouch() {
      ...
      view.addEventListener('tap', function (event) {
        infoText.text = '[View] click';
      });
      var text = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text.text = "Text";
      text.style = {
        width: 80,
        height: 80,
      ...
      var button = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      button.text = "Button";
      button.style = {
        position: 'absolute',
        width: 40,
      ...
      var btnDisable = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      ...
      btnDisable.addEventListener('tap', function (event) {
        view.enabled = false;
        text.enabled = false;
    ...
    value: function formatEvent(event) {
      ...
      var direction = event.direction ? 'direction: ' + event.direction + ' - ' + this.formatDirection(event.direction) + '\n' : '';
    ...
    key: "formatDirection",
    value: function formatDirection(direction) {
      var strDirection = '';
      switch (direction) {
        case 1:
          strDirection = 'Right';
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_View_Touch.js.map
}
