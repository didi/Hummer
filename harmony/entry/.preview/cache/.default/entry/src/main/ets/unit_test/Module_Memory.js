...
var RootView = /*#__PURE__*/function (_View) {
  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testMemory() {
      ...
      var inputKey = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      var inputValue = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Input();
      ...
      this.infoMap = {};
      this.infoText = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      ...
      btn1.addEventListener('tap', function (event) {
        ...
        _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Memory.set(key, value);
        _this2.infoMap[key] = value;
        _this2.printInfo();
      });
      ...
      btn2.addEventListener('tap', function (event) {
        var key = inputKey.text;
        var value = _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Memory.get(key);
        console.log(key + ": " + value);
        _this2.printInfo();
      });
      ...
      btn3.addEventListener('tap', function (event) {
        var key = inputKey.text;
        _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Memory.remove(key);
        delete _this2.infoMap[key];
        _this2.printInfo();
      });
      var btn4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Button();
      btn4.text = 'exist';
      btn4.style = {
        width: 70,
        height: 40
      ...
      btn4.addEventListener('tap', function (event) {
        var key = inputKey.text;
        var isExist = _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Memory.exist(key);
        console.log(key + " exist: " + exist);
        _this2.infoText.text = 'isExist: ' + isExist;
      });
...
_packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Hummer.render(new RootView('rootid'));
setTimeout(function () {
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Module_Memory.js.map
}
