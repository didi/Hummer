import { InvokeType, MethodType } from "@bundle:com.example.hummer/entry/src/main/Hummer/Instruction/IPlatformInst";
import type { IHummerStyle } from '../Style/IHummerStyle';
import type { fn } from '../Utils/Utils';
import type { HarmonyRuntime } from './HarmonyRuntime';
...
export class Element extends External {
     ...
     * 3. 无效值过滤
     * 4. 模型化
     * https://cooper.didichuxing.com/knowledge/2199483284891/2201747305460
     * */
