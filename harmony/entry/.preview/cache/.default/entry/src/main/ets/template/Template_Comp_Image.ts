interface Template_Comp_Image_Params {
    pageData?: IPageData;
...
import { renderFunc } from "@bundle:com.example.hummer/entry/ets/unit_test/Comp_Image";
export class Template_Comp_Image extends ViewPU {
    ...
    setInitiallyProvidedValue(params: Template_Comp_Image_Params) {
    ...
    updateStateVars(params: Template_Comp_Image_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            ViewPU.create(new HMEntrance(this, { controller: this.entranceController, pageData: this.pageData, contentProvider: new HarmonyRuntimeContentProvider(renderFunc) }, undefined, elmtId, paramsLambda, { page: "entry/src/main/ets/template/Template_Comp_Image.ets", line: 29 }));
                        }
                        else {
            ...
            NavDestination.debugLine("entry/src/main/ets/template/Template_Comp_Image.ets(28:5)");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
registerNamedRoute(() => new Template_Comp_Image(undefined, {}), "", { bundleName: "com.example.hummer", moduleName: "entry", pagePath: "template/Template_Comp_Image" });
