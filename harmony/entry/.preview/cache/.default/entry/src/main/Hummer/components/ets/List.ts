...
import { shouldBindEvent } from "@bundle:com.example.hummer/entry/src/main/Hummer/Components/ets/EventHandler";
import { OnScrollBottomEventName, OnScrollTopEventName, ScrollEventName, ScrollEventState, } from "@bundle:com.example.hummer/entry/src/main/Hummer/Components/Event";
import type { ScrollEvent } from "@bundle:com.example.hummer/entry/src/main/Hummer/Components/Event";
import type { IHummerListStyle } from '../../Style/IHummerStyle';
import { isUndefined, timestamp } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/Utils";
import type { HMAny } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/Utils";
import { getEdgeEffect, getListDirection, getScrollBarState, getVP } from "@bundle:com.example.hummer/entry/src/main/Hummer/AttributeModifiers/Utils";
import { RefreshLoadMoreInfoClass, listTouchEvent } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/RefreshLoadMoreHelper";
...
export default class HMList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/Hummer/Components/ets/List.ets(335:5)");
    ...
    LoadMoreComponent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/Hummer/Components/ets/List.ets(364:5)");
            Text.height(70);
    ...
    RefreshComponent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/Hummer/Components/ets/List.ets(382:7)");
            // if (this.refreshNode) {
            //   Column() {
            //     componentFactoryBuilder({
            //       hmContext : this.hmContext,
    ...
    listBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/Hummer/Components/ets/List.ets(391:5)");
            ...
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/Hummer/Components/ets/List.ets(397:9)");
                    };
    ...
    gridBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Grid.debugLine("entry/src/main/Hummer/Components/ets/List.ets(434:5)");
            ...
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("entry/src/main/Hummer/Components/ets/List.ets(438:9)");
                    };
                    const observedDeepRender = () => {
    ...
    waterFallBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            WaterFlow.debugLine("entry/src/main/Hummer/Components/ets/List.ets(483:5)");
        ...
        }, WaterFlow);
        {
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    FlowItem.create();
                    FlowItem.debugLine("entry/src/main/Hummer/Components/ets/List.ets(487:9)");
                    FlowItem.onAppear(() => {
                        // 节点渲染时 触发onUpdate回调
                        this.attributes?.onUpdate(index, this.listItemNodeList[index]);
                    });
