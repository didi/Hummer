...
import { getQueryString } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/Url";
import { HUMMER_UN_SUPPORTED_TYPE_ERROR } from "@bundle:com.example.hummer/entry/src/main/Hummer/Utils/Error";
type HMResponse = {
    status: number;
    header?: object;
    error?: {
