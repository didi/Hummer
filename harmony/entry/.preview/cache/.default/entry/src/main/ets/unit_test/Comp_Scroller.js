...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    _this.scroll = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Scroller();
    _this.scroll.style = {
      width: '100%',
      height: '100%'
    };
    ...
    for (var i = 0; i < 10; i++) {
      var item = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      item.text = "" + i;
      item.style = {
        width: '100%',
        height: 120,
      ...
      _this.scroll.appendChild(item);
    }

    // 下拉刷新和加载更多
    _this.page = 1;
    var pullRefreshCell = new PullRefreshCell();
    _this.scroll.refreshView = pullRefreshCell;
    _this.scroll.onRefresh = function (state) {
    ...
    _this.scroll.loadMoreView = loadMoreCell;
    _this.scroll.onLoadMore = function (state) {
    ...
    _this.scroll.addEventListener('scroll', function (event) {
    ...
    _this.scroll.setOnScrollToTopListener(function () {
      console.log('ScrollToTop!');
    });
    _this.scroll.setOnScrollToBottomListener(function () {
    ...
    btn2.addEventListener("tap", function (event) {
      _this.scroll.scrollToBottom();
    });
    btnLayout.appendChild(btn1);
    btnLayout.appendChild(btn2);
    _this.appendChild(btnLayout);
    return _this;
  }
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function loadMore() {
      ...
      if (this.page < 1000) {
        setTimeout(function () {
          _this3.scroll.stopLoadMore(true);
          // do something
        }, 300);
      } else {
...
var PullRefreshCell = /*#__PURE__*/function (_View2) {
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_2__["default"])(PullRefreshCell, _View2);
  var _super2 = (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(PullRefreshCell);
  function PullRefreshCell() {
    ...
    _this4.textView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
    _this4.textView.text = 'PullRefreshCell';
    _this4.appendChild(_this4.textView);
    return _this4;
  }
...
var LoadMoreCell = /*#__PURE__*/function (_View3) {
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_2__["default"])(LoadMoreCell, _View3);
  var _super3 = (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(LoadMoreCell);
  function LoadMoreCell() {
    ...
    _this5.textView = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
    _this5.textView.text = 'LoadMoreCell';
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Scroller.js.map
}
