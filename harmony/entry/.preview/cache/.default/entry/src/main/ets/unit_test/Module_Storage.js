  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testStorage() {
      ...
      btn1.addEventListener('tap', function (event) {
        ...
        _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Storage.set(key, value);
      ...
      btn2.addEventListener('tap', function (event) {
        var key = inputKey.text;
        var value = _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Storage.get(key);
        console.log(key + ": " + value);
        _this2.printInfo();
      });
      ...
      btn3.addEventListener('tap', function (event) {
        var key = inputKey.text;
        _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Storage.remove(key);
      ...
      btn4.addEventListener('tap', function (event) {
        var key = inputKey.text;
        var isExist = _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Storage.exist(key);
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Module_Storage.js.map
}
