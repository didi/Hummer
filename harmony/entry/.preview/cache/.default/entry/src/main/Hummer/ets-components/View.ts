interface View_Params {
    ...
    children?: Node[];
    style?: HummerStyle | undefined;
    attributes?: AttributesType | undefined;
}
import { FlexManager } from "@bundle:com.example.hummer/entry/src/main/Hummer/AttributeModifiers/Utils";
...
import type HummerStyle from '../Style/HummerStyle';
import commonStyleModifier from "@bundle:com.example.hummer/entry/src/main/Hummer/AttributeModifiers/CommonStyleModifier";
import { componentFactoryBuilder } from "@bundle:com.example.hummer/entry/src/main/Hummer/ets-components/ComponentBuilder";
import type { ComponentBuilderContext } from "@bundle:com.example.hummer/entry/src/main/Hummer/ets-components/ComponentBuilder";
import { dispatchTapEvent, dispatchTouchEvent, shouldBindEvent } from "@bundle:com.example.hummer/entry/src/main/Hummer/ets-components/EventHandler";
...
export default class View extends ViewPU {
    ...
    private __style: ObservedPropertyObjectPU<HummerStyle | undefined>;
    get style() {
        return this.__style.get();
    }
    set style(newValue: HummerStyle | undefined) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.hmContext.useYoga) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("entry/src/main/Hummer/ets-components/View.ets(48:7)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Flex.debugLine("entry/src/main/Hummer/ets-components/View.ets(55:7)");
                        Flex.attributeModifier.bind(this)(commonStyleModifier.setNode(this.node));
                        ...
                        Flex.clip(this.style!.overflow == 'hidden');
                    }, Flex);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ForEach.create();
