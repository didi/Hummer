...
export default class View extends ViewPU {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.hmContext.useYoga) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("entry/src/main/Hummer/Components/ets/View.ets(53:7)");
    ...
    buildColumn(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/Hummer/Components/ets/View.ets(73:5)");
    ...
    buildRow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/Hummer/Components/ets/View.ets(85:5)");
    ...
    buildFlex(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/Hummer/Components/ets/View.ets(97:5)");
