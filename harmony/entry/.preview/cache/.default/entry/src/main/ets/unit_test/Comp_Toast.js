...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    btn1.addEventListener('tap', function (event) {
      // Toast.show("test");
      _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Toast.show("test", 3000);
    });
    ...
    btn2.addEventListener('tap', function (event) {
      ...
      _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Toast.custom(layout);
    });
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Toast.js.map
}
