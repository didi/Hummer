...
var RootView = /*#__PURE__*/function (_Scroller) {
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_2__["default"])(RootView, _Scroller);
  ...
  function RootView() {
    ...
    _this.testBackground();
    _this.testSrc();
    _this.testSrcResize();
    _this.testGifResize();
    _this.testImageReady();
    return _this;
  }
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testBackground() {
      ...
      var layout1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      layout1.style = {
        flexDirection: 'row'
      };
      var layout2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      layout2.style = {
        flexDirection: 'row'
      };
      var img1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img1.style = {
        width: 60,
        height: 60,
        backgroundColor: '#FF0000'
      };
      var img2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img2.style = {
        width: 60,
        height: 60,
      ...
      var img3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img3.style = {
        width: 60,
        height: 60,
      ...
      var img4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img4.style = {
        width: 80,
        height: 60,
      ...
      var img5 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img5.style = {
        width: 60,
        height: 60,
        backgroundColor: '#FF0000',
      ...
      var img6 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img6.style = {
        width: 60,
        height: 60,
        backgroundColor: '#FF0000',
      ...
      var img7 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img7.style = {
        width: 60,
        height: 60,
        backgroundColor: 'linear-gradient(90deg #FF000060 #00FF0060)',
      ...
      var img8 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img8.style = {
        width: 80,
        height: 60,
        backgroundImage: 'njimage_demo',
    ...
    key: "loadResImage",
    value: function loadResImage(layout, resId, isGif) {
      var subLayout1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout1.style = {
        alignItems: 'center'
      };
      var img1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      ...
      var text1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text1.text = 'origin';
      text1.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout2.style = {
        alignItems: 'center',
        marginLeft: 10
      };
      ...
      var text2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text2.text = 'contain';
      text2.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout3.style = {
        alignItems: 'center',
        marginLeft: 10
      };
      ...
      var text3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text3.text = 'cover';
      text3.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout4.style = {
        alignItems: 'center',
        marginLeft: 10
      };
      ...
      var text4 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
    ...
    key: "loadRemoteImage",
    value: function loadRemoteImage(layout, url, isGif) {
      var subLayout5 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout5.style = {
        alignItems: 'center',
        marginTop: 10
      };
      ...
      var text5 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text5.text = 'origin';
      text5.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout6 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout6.style = {
        alignItems: 'center',
        marginLeft: 10,
        marginTop: 10
      ...
      var text6 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text6.text = 'contain';
      text6.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout7 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout7.style = {
        alignItems: 'center',
        marginLeft: 10,
        marginTop: 10
      ...
      var text7 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
      text7.text = 'cover';
      text7.style = {
        fontSize: 12,
        textAlign: 'center'
      };
      var subLayout8 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.View();
      subLayout8.style = {
        alignItems: 'center',
        marginLeft: 10,
        marginTop: 10
      ...
      var text8 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Text();
    ...
    value: function testImageReady() {
      ...
      var img1 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img1.load('https://pt-starimg.didistatic.com/static/starimg/img/WjRyAMkJbL1607860816543.jpg', function (srcType, isSuccess) {
        if (isSuccess) {
          console.log("xxxx____RemoteLoad Success  srcType = ".concat(srcType));
        } else {
          console.log("xxxx____RemoteLoad Fail  srcType = ".concat(srcType));
        }
      });
      img1.style = {
        width: 60,
      ...
      var img2 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img2.load('njimage_demo', function (srcType, isSuccess) {
        if (isSuccess) {
          console.log("xxxx____ResIdLoad Success  srcType = ".concat(srcType));
        } else {
          console.log("xxxx____ResIdLoad Fail  srcType = ".concat(srcType));
        }
      });
      img2.style = {
        width: 60,
      ...
      var img3 = new _packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Image();
      img3.load('//pt-starimg.didistatic.com/static/starimg/img/WjRyAMkJbL1607860816543.jpg', function (srcType, isSuccess) {
        if (isSuccess) {
          console.log("xxxx____RemoteSimpleLoad Success  srcType = ".concat(srcType));
        } else {
          console.log("xxxx____RemoteSimpleLoad fail  srcType = ".concat(srcType));
        }
      });
      img3.style = {
        width: 60,
      ...
      }, function (srcType, isSuccess) {
        if (isSuccess) {
          console.log("xxxx____ObjectRemoteLoad Success  srcType = ".concat(srcType));
        } else {
          console.log("xxxx____ObjectRemoteLoad fail  srcType = ".concat(srcType));
        }
      });
      img4.style = {
        width: 60,
      ...
      img5.load({
        ...
        if (isSuccess) {
          console.log("xxxx____ObjectLocalLoad Success  srcType = ".concat(srcType));
        } else {
          console.log("xxxx____ObjectLocalLoad fail  srcType = ".concat(srcType));
        }
      });
      img5.style = {
        width: 60,
  ...
  return RootView;
}(_packages_hummer_api_dist_hummer_api_es__WEBPACK_IMPORTED_MODULE_5__.Scroller);
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Image.js.map
}
