...
var RootView = /*#__PURE__*/function (_View) {
  ...
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(RootView, [{
    ...
    value: function testSrc() {
      ...
      img1.load(imageBase64, function (srcType, isSuccess) {
        if (isSuccess) {
          console.log("success ".concat(srcType));
        } else {
          console.log("fail ".concat(srcType));
        }
      });
      img1.style = {
        width: 80,
...
/******/ })()
;
//# sourceMappingURL=http://172.23.161.208:8000/Comp_Image_base64.js.map
}
