...
export default class HMSwiper extends ViewPU {
    ...
    defaultImage(uri: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/Hummer/Components/ets/Swiper.ets(197:5)");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("entry/src/main/Hummer/Components/ets/Swiper.ets(206:5)");
        ...
        }, Swiper);
        {
            const __lazyForEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/Hummer/Components/ets/Swiper.ets(208:9)");
                    Column.onClick((e) => {
