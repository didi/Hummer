...
export default class HMImage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/Hummer/ets-components/Image.ets(90:5)");
            Image.objectFit(this.resize);
            Image.attributeModifier.bind(this)(commonStyleModifier.setNode(this.node));
            ...
            Image.clip(this.style!.overflow == 'hidden');
        }, Image);
    }
    rerender() {
